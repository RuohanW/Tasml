...
data_path = osp.expanduser("~/workspace/data/embeddings")


FLAGS = flags.FLAGS
flags.DEFINE_string("data_path", data_path, "Path to the dataset.")
flags.DEFINE_string(
...
flags.DEFINE_integer("num_latents", 64, "The dimensionality of the latent "
                     "space.")
flags.DEFINE_float(
    "inner_lr_init", 1., "The initialization value for the "
...
flags.DEFINE_integer(
    "num_tr_examples_per_class", 5, "Number of training samples per class, "
...
flags.DEFINE_integer("metatrain_batch_size", 12, "Number of problem instances "
                     "in a batch.")
flags.DEFINE_integer("metavalid_batch_size", 100, "Number of meta-validation "
                     "problem instances.")
